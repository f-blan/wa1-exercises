...
function Task(id, description, isUrgent = 0, isPrivate = 1, deadline = '', completed = 0, user = 1) {
    this.id = id;
...
function get_Filters(){
    ...
    filters.push({name: 'All', filter : filter_all, apiname: "all"});
    filters.push({name: 'Important', filter : filter_important,apiname: "important"});
    filters.push({name: 'Today', filter : filter_today,apiname: "today"})
    filters.push({name: 'Private', filter : filter_private,apiname: "private"});
    filters.push({name: 'Next 7 Days', filter : filter_bseven,apiname: "next7days"});
