...
function TaskRow(props){
    ...
    let date = dayjs(props.task.deadline).format("dddd, MMMM D YYYY hh:mm ");
    ...
    return(
        ...
        <Col xs = {{ span: 3, offset: 1 }}>
            <Form.Check type="checkbox" checked = {props.task.completed} 
            className = {important} label={props.task.description} onChange = {() => {props.task.completed = !props.task.completed; props.mark(props.task)}}/>
        </Col>
